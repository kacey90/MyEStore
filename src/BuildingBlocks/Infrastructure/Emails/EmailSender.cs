using Project.EStore.BuildingBlocks.Application.Data;
using Project.EStore.BuildingBlocks.Application.Emails;
using RepoDb;
using Serilog;
using System;

namespace Project.EStore.BuildingBlocks.Infrastructure.Emails
{
